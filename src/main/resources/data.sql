INSERT INTO `user` (`username`, `password`, `salt`, `role`, `emailaddress`, `firstname`, `prefix`,`lastname`, `address`, `houseNumber`, `zipcode`, `city`, `dateOfBirth`, `bsn`) VALUES ('Harold', 'dlorah','123', 'client', 'info@hjstevens.nl', 'Harold', '', 'Stevens', 'Pieter Woutersstraat', '26', '2215MC', 'Voorhout', '1973-09-25', '123456007');
INSERT INTO `user` (`username`, `password`, `salt`, `role`, `emailaddress`, `firstname`,`prefix`, `lastname`, `address`, `houseNumber`, `zipcode`, `city`, `dateOfBirth`, `bsn`) VALUES ('Alex', 'xela', '234' ,'client', 'alex@hva.nl', 'Alex', '', 'Shijan', 'Koningstraat', '10', '1010DS', 'Amsterdam', '1990-08-25', '123465992');
INSERT INTO `user` (`username`, `password`, `salt`, `role`, `emailaddress`, `firstname`, `prefix`,`lastname`, `address`, `houseNumber`, `zipcode`, `city`, `dateOfBirth`, `bsn`) VALUES ('Hannah', 'hannah', '345','client', 'hannah@hva.nl', 'Hannah', 'van', 'Dam', 'Prinsessenstraat', '29', '1300PT', 'Rotterdam', '1999-01-07', '123477759');
